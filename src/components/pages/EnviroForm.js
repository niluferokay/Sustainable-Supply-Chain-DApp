          ...
          <form className="LCI-form" onSubmit={onSubmit}>
              ...
              <fieldset className="monthly-kpi-env"><legend>Monthly KPI Update</legend>
                  <div className='center-form-input'>
                      ...
                      <label 
                          className="form-label">
                          10 - Total amount of land pollution generated per month
                          </label>
                          <input 
                              type='number' min='0' onWheel={(e) => e.target.blur()} step=".001"
                      ...
                      <label 
                          className="form-label">
                          12 - Total amount of air emission (NOx, SOx) generated per month 
                          </label>
                          <input 
                              type='number' min='0' onWheel={(e) => e.target.blur()} step=".001"
              ...
              <div>
                      ...
                      <label 
                          className="form-label">
                          5 - Choose the type(s) of clean technology used
                          </label>
                          <div></div> 
                          <input 
                              type="checkbox"
